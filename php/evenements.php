...
<head>
    ...
    <link rel="stylesheet" href="<?= CSS_PATH ?>/evenements.css">
    <style>
        .page-container {
            min-height: 100vh;
            display: flex;
        ...
        <main>
            ...
            <div class="container-events">
                ...
                <div class="carte-event">
                    <img src="<?= IMAGES_PATH ?>/<?php echo htmlspecialchars($image); ?>" class="carte-img"  alt="<?php echo htmlspecialchars($event['titre']); ?>">
